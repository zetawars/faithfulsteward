                        ...
                        <div class="col-md-5">
                            <div class="box box-solid" style="height: 350px">
                                ...
                                <div class="box-body">
                                    ...
                                    <button type="button" class="btn btn-default btn-block fa fa-edit">&nbsp;Edit
                                        Course
                                    </button>
                                    <button type="button" class="btn btn-default btn-block fa fa-eye">&nbsp;View Course
                                        as Learner
                                    </button>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><span>&nbsp;&nbsp;Thomas Kofi Wilmo</span></td>

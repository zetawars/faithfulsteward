        ...
        <section class="content">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab_4" data-toggle="tab">Completion</a></li>
                    <li><a href="#tab_5" data-toggle="tab">Messages</a></li>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="box box-solid">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="button" name="btn" class="btb btn-default btn-block"
                                                    style="margin-left: 300px">Course Introduction
                                            </button>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="button" name="btn" class="btb btn-default btn-block"
                                                    style="margin-left: 300px">Module #1Entrance Exam
                                            </button>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="button" name="btn" class="btb btn-default btn-block"
                                                    style="margin-left: 300px">Module #1Workbook
                                            </button>
                                        </div>
                                    </div>
                                    <br>
                            ...
                            <div class="box box-solid">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="button" name="btn" class="btb btn-default btn-block"
                                                    style="margin-left: 300px">Who's the Boss?
                                            </button>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="button" name="btn" class="btb btn-default btn-block"
                                                    style="margin-left: 300px">Leave it to the Boss
                                            </button>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button type="button" name="btn" class="btb btn-default btn-block"
                                                    style="margin-left: 300px">Know your Role
                                            </button>
                                        </div>
                                    </div>
                                    <br>
                        ...
                        <div class="col-md-8">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#">Thomas Kofi Wilmot</a></li>
                                    <li><a href="#">Dr.Annie</a></li>
                                    <li><a href="#">Other Instructor</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
